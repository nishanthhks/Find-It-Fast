...
class MyApp extends StatelessWidget {
  ...
  Future<bool> isAdminUser(User? user) async {
    ...
    // For example, check a field in Firestore user document
    // This is just a placeholder and should be adapted to your actual user data structure
    // Assuming you have a collection 'users' with a document for each user
    try {
